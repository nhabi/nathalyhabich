(async function () {
  ...
  heroCopy.innerHTML = isEnglish ? `
      ...
      <tr><th scope="row">Client</th><td>Latina Television / Rayo en la Botella</td></tr>
      ...
      <tr><th scope="row">Outcome</th><td>Designed and art directed +60 unique themed sets in a continuous daily production format, delivering a visually distinct stage for every episode each with its own aesthetic identity, camera presence, and narrative coherence, within a 24 to 48-hour fabrication and installation cycle.</td></tr>
      </tbody></table>
    ` : `
      <h3 class="project-video-hero-copy__title">Me Caigo de Risa Perú</h3>
      <table class="project-video-hero-table">
      <tbody>
      <tr><th scope="row">Cliente</th><td>Latina Televisión / Rayo en la Botella</td></tr>
      ...
      <tr><th scope="row">Resultado</th><td>Diseño y dirección de arte de +60 escenografías temáticas únicas en formato de producción continua, logrando un set visualmente distinto cada día con identidad estética propia, impacto en cámara y coherencia con la narrativa del episodio, dentro de un ciclo de fabricación y montaje de 24 a 48 horas.</td></tr>
      </tbody>
      </table>
    `;
