(async function () {
  ...
  if (firstVideo) {
    ...
    heroCopy.innerHTML = isEnglish ? `
      <h3 class="project-video-hero-copy__title">Me Caigo de Risas Perú</h3>
      ...
      <tr><th scope="row">Overview</th><td><p>Production design for the inclined stage on Me Caigo de Risas Perú, the Peruvian adaptation of the internationally produced format originally developed in Mexico.</p><p>The role required designing a completely new themed set every single day, built entirely from lightweight materials, with a 24 to 48-hour fabrication and installation window per episode. No art department existed prior to joining the project — the entire workflow was built from scratch.</p></td></tr>
...
` : `
      ...
      <tbody>
      <tr><th scope="row">Cliente</th><td>Rayo en la Botella / Latina Televisión</td></tr>
      <tr><th scope="row">Tipo de producción</th><td>Formato de entretenimiento en vivo comedia física con grabación diaria de lunes a viernes</td></tr>
